...
<body>
  ...
  <div class="bg-primary" id="sidebar-wrapper">
    <div class="sidebar-heading border-bottom bg-primary text-light text-center">Desa Tamboo</div>
  ...
  <script>
    $(document).ready(function(){
      ...
      function load_halaman(url,menu){
        $.ajax({
          beforeSend : function(){ $('#content').html('<center><img src="../images/loading.gif" alt="" width="150px" class="img-fluid mt-5"></center>') },
          url : url,
