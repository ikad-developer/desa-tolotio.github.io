        ...
        ?>
          <tr>
            ...
            <td style="min-width: 230px ;">
              ...
              <button type="button" class="btn btn-warning btn-sm edit" data-penduduk="<?= $data['nik']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button>
              <button type="button" class="btn btn-danger btn-sm hapus" data-nik="<?= $data['nik']; ?>" data-penduduk="<?= $data['nama']; ?>"><i class="fa fa-trash" aria-hidden="true"></i> Hapus</button>
            </td>
          </tr>
        <?php
          $i++;
...
<script>
  $(document).ready(function() {
    ...
    $('.detail').click(function() {
      ...
      $.ajax({
        beforeSend: function() {
          $('#content-detail').html('<center><img src="../images/loading.gif" alt="" width="210px"></center>')
        },
